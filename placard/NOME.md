...
- Você tem 5 cartas na mão. Coloca **uma** numa casa vazia por turno e compra de
  volta. A carta fica ali para sempre.
...
**Depois**, escolha **3 favoritas** e defenda cada uma em um parágrafo curto,
...
### Duas liberdades que você tem

- **Pode inventar palavras.** Um nome sem significado nenhum passa no critério 4
  por construção — foi assim que *Tetris* e *Kodak* nasceram.
- **Pode ir a línguas mortas ou construídas** (latim, grego, esperanto). É o
