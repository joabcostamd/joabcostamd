...
| 4 | **Desempenho** | 8 | PORTÃO | `tools/perf.gd -- 402` | **p90 de `Jogo.simular()` ≤ 4 ms nas DUAS pernas**: 10 min de jogo real, e 160 inimigos vivos segurados (o teto que `Bal.contagem_onda` sabe criar, mais 25%). O estresse de 402 é publicado como folga e não reprova, porque o jogo não produz essa população |
...
| Testes da simulação | 402 |
| Chaves de interface PT/EN | 1.033 |
