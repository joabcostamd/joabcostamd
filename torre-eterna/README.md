...
![Testes](https://img.shields.io/badge/Testes-683%2F683-4ade80)
...
# Suíte de testes da simulação — 683 testes, sem mocks
...
- **683** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
