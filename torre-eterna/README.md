...
![Testes](https://img.shields.io/badge/Testes-663%2F663-4ade80)
...
# Suíte de testes da simulação — 663 testes, sem mocks
...
- **663** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
