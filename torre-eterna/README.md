...
![Testes](https://img.shields.io/badge/Testes-630%2F630-4ade80)
...
# Suíte de testes da simulação — 630 testes, sem mocks
...
- **630** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
