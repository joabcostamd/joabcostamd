...
![Testes](https://img.shields.io/badge/Testes-1035%2F1035-4ade80)
...
# Suíte de testes da simulação — 1035 testes, sem mocks
...
- **1035** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
