...
![Testes](https://img.shields.io/badge/Testes-649%2F649-4ade80)
...
# Suíte de testes da simulação — 649 testes, sem mocks
...
- **649** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
