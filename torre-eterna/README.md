...
![Testes](https://img.shields.io/badge/Testes-616%2F616-4ade80)
...
# Suíte de testes da simulação — 616 testes, sem mocks
...
- **616** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
