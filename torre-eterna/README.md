...
![Testes](https://img.shields.io/badge/Testes-608%2F608-4ade80)
...
# Suíte de testes da simulação — 608 testes, sem mocks
...
- **608** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
