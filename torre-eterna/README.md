...
# Suíte de testes da simulação — 370 testes, sem mocks
...
- **1.027** chaves de interface e **1.286** textos de conteúdo, em português e inglês
- **370** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
