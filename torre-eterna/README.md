...
![Testes](https://img.shields.io/badge/Testes-637%2F637-4ade80)
...
# Suíte de testes da simulação — 637 testes, sem mocks
...
- **637** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
