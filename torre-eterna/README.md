...
![Testes](https://img.shields.io/badge/Testes-668%2F668-4ade80)
...
# Suíte de testes da simulação — 668 testes, sem mocks
...
- **668** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
