...
# Suíte de testes da simulação — 396 testes, sem mocks
...
- **1.030** chaves de interface e **1.286** textos de conteúdo, em português e inglês
- **396** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
