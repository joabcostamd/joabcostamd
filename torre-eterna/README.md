...
![Testes](https://img.shields.io/badge/Testes-589%2F589-4ade80)
...
# Suíte de testes da simulação — 589 testes, sem mocks
...
- **1.053** chaves de interface e **1.286** textos de conteúdo, em português e inglês
- **589** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
