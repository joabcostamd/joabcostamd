...
![Testes](https://img.shields.io/badge/Testes-601%2F601-4ade80)
...
# Suíte de testes da simulação — 601 testes, sem mocks
...
- **601** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
