...
![Testes](https://img.shields.io/badge/Testes-670%2F670-4ade80)
...
# Suíte de testes da simulação — 670 testes, sem mocks
...
- **670** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
