...
![Testes](https://img.shields.io/badge/Testes-720%2F720-4ade80)
...
# Suíte de testes da simulação — 720 testes, sem mocks
...
- **720** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
