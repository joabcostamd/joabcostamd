...
# Suíte de testes da simulação — 315 testes, sem mocks
...
- **970** chaves de interface e **1.286** textos de conteúdo, em português e inglês
- **315** testes da simulação · **0** imagem · **0** arquivo de som
