...
![Testes](https://img.shields.io/badge/Testes-741%2F741-4ade80)
...
# Suíte de testes da simulação — 741 testes, sem mocks
...
- **741** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
