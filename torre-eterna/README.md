...
![Testes](https://img.shields.io/badge/Testes-632%2F632-4ade80)
...
# Suíte de testes da simulação — 632 testes, sem mocks
...
- **632** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
