...
![Testes](https://img.shields.io/badge/Testes-1013%2F1013-4ade80)
...
# Suíte de testes da simulação — 1013 testes, sem mocks
...
- **1013** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
