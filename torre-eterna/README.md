...
![Testes](https://img.shields.io/badge/Testes-658%2F658-4ade80)
...
# Suíte de testes da simulação — 658 testes, sem mocks
...
- **658** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
