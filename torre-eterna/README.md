...
![Testes](https://img.shields.io/badge/Testes-790%2F790-4ade80)
...
# Suíte de testes da simulação — 790 testes, sem mocks
...
- **790** testes da simulação · **0** arquivo de som · a única imagem do repositório é `icon.svg`, o ícone do projeto
